...
public:
    ...
    void retranslateUi(QWidget *Online)
    {
        ...
        ___qlistwidgetitem->setText(QApplication::translate("Online", "1111", nullptr));
        QListWidgetItem *___qlistwidgetitem1 = online_lw->item(1);
        ___qlistwidgetitem1->setText(QApplication::translate("Online", "2222", nullptr));
        online_lw->setSortingEnabled(__sortingEnabled);

        addFriend_pb->setText(QApplication::translate("Online", "Add new friend", nullptr));
    } // retranslateUi
